...
/*   Updated: 2022/09/30 15:15:49 by ntan-wan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sl_player_load_imgs(void *mlx, t_img **imgs)
{
	...
	sl_load_img(mlx, imgs, "k_l_idle0", "sprite/knight/k_l_idle0.xpm");
	sl_load_img(mlx, imgs, "k_l_idle1", "sprite/knight/k_l_idle1.xpm");
	sl_load_img(mlx, imgs, "k_l_idle2", "sprite/knight/k_l_idle2.xpm");
	sl_load_img(mlx, imgs, "k_l_idle3", "sprite/knight/k_l_idle3.xpm");
	sl_load_img(mlx, imgs, "k_l_idle4", "sprite/knight/k_l_idle4.xpm");
	sl_load_img(mlx, imgs, "k_l_idle5", "sprite/knight/k_l_idle5.xpm");
	sl_load_img(mlx, imgs, "k_l_left0", "sprite/knight/k_l_run0.xpm");
	sl_load_img(mlx, imgs, "k_l_left1", "sprite/knight/k_l_run1.xpm");
	sl_load_img(mlx, imgs, "k_l_left2", "sprite/knight/k_l_run2.xpm");
	sl_load_img(mlx, imgs, "k_l_left3", "sprite/knight/k_l_run3.xpm");
	sl_load_img(mlx, imgs, "k_l_left4", "sprite/knight/k_l_run4.xpm");
	sl_load_img(mlx, imgs, "k_l_left5", "sprite/knight/k_l_run5.xpm");
...
{
	sl_anim_add_frame(player->idle_right, sl_img_search("k_idle0", imgs));
	sl_anim_add_frame(player->idle_right, sl_img_search("k_idle1", imgs));
	sl_anim_add_frame(player->idle_right, sl_img_search("k_idle2", imgs));
	sl_anim_add_frame(player->idle_right, sl_img_search("k_idle3", imgs));
	sl_anim_add_frame(player->idle_right, sl_img_search("k_idle4", imgs));
	sl_anim_add_frame(player->idle_right, sl_img_search("k_idle5", imgs));
	...
	sl_anim_add_frame(player->move_left, sl_img_search("k_l_left0", imgs));
	sl_anim_add_frame(player->move_left, sl_img_search("k_l_left1", imgs));
	sl_anim_add_frame(player->move_left, sl_img_search("k_l_left2", imgs));
	sl_anim_add_frame(player->move_left, sl_img_search("k_l_left3", imgs));
	sl_anim_add_frame(player->move_left, sl_img_search("k_l_left4", imgs));
	sl_anim_add_frame(player->move_left, sl_img_search("k_l_left5", imgs));
	sl_anim_add_frame(player->idle_left, sl_img_search("k_l_idle0", imgs));
	sl_anim_add_frame(player->idle_left, sl_img_search("k_l_idle1", imgs));
	sl_anim_add_frame(player->idle_left, sl_img_search("k_l_idle2", imgs));
	sl_anim_add_frame(player->idle_left, sl_img_search("k_l_idle3", imgs));
	sl_anim_add_frame(player->idle_left, sl_img_search("k_l_idle4", imgs));
	sl_anim_add_frame(player->idle_left, sl_img_search("k_l_idle5", imgs));
